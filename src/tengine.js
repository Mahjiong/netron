...
tengine.BinaryReader = class {
    ...
    bytes(size) {
        const next = this._position + size;
        const data = this._buffer.slice(this._position, next);
        this._position = next;
        return data;
    }
    ...
    int16() {
        return this._buffer[this._position++] | this._buffer[this._position++] << 8;
    }

    int32() { 
        return this.int16() | this.int16() << 16;
    }
